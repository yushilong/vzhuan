...
import com.vzhuan.MainActivity;
import com.vzhuan.ShareUtil;
...
public class MyPushMessageReceiver extends FrontiaPushMessageReceiver
{
    ...
    @Override public void onBind(Context context, int errorCode, String appid, String userId, String channelId, String requestId)
    {
        ...
        ShareUtil.setString(context,ShareUtil.ShareKey.KEY_USER_ID,userId);
        ShareUtil.setString(context,ShareUtil.ShareKey.KEY_CHANNEL_ID,userId);
//        B5MPreferenceHelper.saveStringValue(context, Constants.PREFERENCE_BAIDUPUSH_USERID, userId);
//        B5MPreferenceHelper.saveStringValue(context, Constants.PREFERENCE_BAIDUPUSH_CHANNELID, channelId);
//        String currentUserId = B5MPreferenceHelper.readStringValue(MainApplication.getInstance(), Constants.PREFERENCE_USER_USERID);
//        if (!TextUtils.isEmpty(currentUserId))
//        {
//            pushRelation(userId, channelId);
//        }
    }

//    private void pushRelation(String userId, String channelId)
//    {
//        // TODO Auto-generated method stub
//        if (!TextUtils.isEmpty(userId) && !TextUtils.isEmpty(channelId))
//        {
//            new B5MRequest(B5MAPIMethods.PUSH_RELATION, new IB5MResponseListenerImpl()).setRequestBody(B5MRequestBodyManager.getPushRelationJsonObject(userId, channelId)).start();
//        }
//    }
    ...
    {
        String messageString = "推送消息 message=\"" + message + "\" customContentString=" + customContentString;
     ...
     *            分配给对云推送的请求的id
     */
    @Override public void onSetTags(Context context, int errorCode, List<String> sucessTags, List<String> failTags, String requestId)
    {
     ...
     *            分配给对云推送的请求的id
     */
    @Override public void onDelTags(Context context, int errorCode, List<String> sucessTags, List<String> failTags, String requestId)
    {
