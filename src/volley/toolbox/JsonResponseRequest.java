 ...
 */
public class JsonResponseRequest extends JsonRequest<ResponseResult>
{
    /**
     ...
     */
    public JsonResponseRequest(int method, String url, JSONObject jsonRequest, Response.Listener<ResponseResult> listener, Response.ErrorListener errorListener)
    {
    ...
    public JsonResponseRequest(int method, String url, Response.Listener<ResponseResult> listener, Response.ErrorListener errorListener)
    {
    ...
    protected Response<ResponseResult> parseNetworkResponse(NetworkResponse response)
    {
        try
        {
            ...
            ResponseResult responseResult = new ResponseResult(response.statusCode, jsonString);
            return Response.success(responseResult, HttpHeaderParser.parseCacheHeaders(response));
        }
