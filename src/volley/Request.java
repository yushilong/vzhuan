...
public abstract class Request<T> implements Comparable<Request<T>>
{
    ...
    protected Map<String, String> getMapParams() throws AuthFailureError
    {
        return map;
    }

    public Request(String url, Response.ErrorListener listener, Map<String, String> map)
    {
        this(Method.DEPRECATED_GET_OR_POST, url, listener, map);
    }

    public Request(int method, String url, Response.ErrorListener listener, Map<String, String> map)
    {
        mMethod = method;
        mUrl = url;
    ...
    /**标识是否需要强制刷新缓存内容*/
    private boolean mRefreshCacheNeeded = true;
    /**
     ...
     * @return
     */
    public Request<?> setRefreshCacheNeeded(boolean needed)
    {
     ...
     * @return
     */
    public boolean getRefreshCacheNeeded()
    {
        return mRefreshCacheNeeded;
    }
     ...
     * @return
     */
    public Request<?> setCacheExpiredTime(long expiredtime)
    {
        mCacheExpiredTime = expiredtime;
        return this;
    }

    /***
     * 读取设置的缓存过期时间，初始化请求时的设置
     * @return
     */
    public long getCacheExpiredTime()
    {
        return mCacheExpiredTime;
    }
